...
| GET    | `/learning-resources`                  | List resources; optional query params: page, pageSize, resourceTypeId, topicIds, status, difficulty, energyLevel |
| GET    | `/learning-resources/suggestions`      | Fuzzy title search — up to 5 similar resources via pg_trgm                                                       |
