  ...
  template: `
    ...
    >
      <div class="max-w-md w-full text-center">
        ...
        <h1 class="text-2xl font-bold text-ink dark:text-slate-100 mb-2">Import from URL</h1>
        <p class="text-sm text-ink-muted dark:text-slate-400 mb-8">
          Paste a URL and we'll automatically fetch the title, description and resource type. Coming
          in a future release.
        </p>
        <button
          (click)="goBack()"
